...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    text = (
        ...
        "Я, Магистр Флавиус Абессинский, Архимаг Школы Трансмутации и Небесный Предсказатель Скидок, прозреваю сквозь туманы измерений, чтобы узреть\n"
        "твое великое... <b>повышение уровня!</b> 🌟\n"
        "Желаю <b>Критических Успехов</b> во всех делах, бесконечного запаса <b>Хит Поинтов</b> для здоровья и золота, чтобы всегда хватало на лучшие зелья и\n"
